...
def test_validate_username_raises_on_none():
    with pytest.raises(TypeError, match="Username must be a non-empty string"):
        GraphTraversalRepository._validate_username(None)

def test_validate_username_raises_on_empty_string():
    with pytest.raises(TypeError, match="Username must be a non-empty string"):
        GraphTraversalRepository._validate_username("")

def test_validate_username_raises_on_whitespace():
    with pytest.raises(TypeError, match="Username must be a non-empty string"):
        GraphTraversalRepository._validate_username("   ")
